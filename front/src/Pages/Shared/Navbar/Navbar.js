...
const Navbar = () => {
    ...
    const menus = <>
        <li><Link to='/getintouch' className='font-bold'>Get in touch</Link></li>
        <li><Link to='/officeQuestion' className='font-bold'><button className='bg-green-300 py-2 px-5 bg-[#FCE72D] rounded-full'>Start Createing</button></Link></li>
    ...
    return (
        <div className="navbar lg:px-20 ">
            <div className="navbar-start justify-between w-full">
                ...
                <Link to='/' className=" normal-case text-xl sm:text-2xl text-[#1F2C56] font-bold text-4xl">SnapSpace</Link>
                <div className="dropdown">
                    ...
                    <div className={`dropdown-menu bg-yellow-400 fixed w-full h-screen top-0 left-0 ${!mobileNav ? 'hidden' : ''}`} >
                        <div className="navmobilehead flex justify-between p-5  items-center">
                            <Link to='/' className=" normal-case text-xl text-[#1F2C56] font-bold text-4xl">SnapSpace</Link>
                        ...
                        <div>
                            <ul className='text-left mt-[10vh] ml-5'>
                                ...
                                <li><Link to='/getintouch' className='text-[24px] font-bold'>Get in touch</Link></li>
                                <li><Link to='/about' className='text-[24px] font-bold'>About us</Link></li>
                                <li><Link to='/tarms' className='text-[24px] font-bold'>Terms</Link></li>
                        ...
                        <div>
                            <ul className='flex justify-center items-end'>
                                ...
                                <li><Link to='/officeQuestion' className='font-bold'><button className='bg-[#1F2C56] py-2 mx-2 px-5 text-[white] rounded-full'>Start Createing</button></Link></li>
                            </ul>
                        </div>
